...
const { json, methodNotAllowed, gasUrl, isLikelyGasExecUrl, normalizeTimeoutMs, RELEASE_STAMP } = require("./_gasProxyCommon");
...
module.exports = async function(req, res) {
  ...
  try {
    ...
    const response = await fetch(endpoint, {
      method: "GET",
      redirect: "follow",
      headers: { Accept: "application/json, text/plain, */*", "X-Production-Vercel-Proxy": RELEASE_STAMP },
    ...
    result.meta = Object.assign({}, result.meta && typeof result.meta === "object" && !Array.isArray(result.meta) ? result.meta : {}, {
      vercelProxy: true,
