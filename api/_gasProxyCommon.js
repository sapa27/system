"use strict";
const RELEASE_STAMP = "commission-v1.2-gas-hosted-production-2026-07-23-r152";
...
function gasUrl() {
  return normalizeGasWebAppUrl(process.env.GAS_WEB_APP_URL || process.env.VERCEL_GAS_WEB_APP_URL || DEFAULT_GAS_WEB_APP_URL || "");
}
