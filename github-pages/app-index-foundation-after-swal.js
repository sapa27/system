...
window.__APP_BOOTSTRAP__=(function(root) {
  var cfg = root.APP_CONFIG || {};
  var release = String(cfg.releaseStamp || "commission-v1.2-gas-hosted-production-2026-07-23-r153");
  ...
  return {
    ...
    assetStamp: String(assetManifest.stamp || cfg.assetStamp || "asset-manifest-commission-v1.2-gas-hosted-production-2026-07-23-r153"),
    baseUrl: "",
    uiMode: "vue3",
