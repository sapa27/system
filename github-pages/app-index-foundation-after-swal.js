...
window.__SAFE_LOGO_URL__ = window.currentLogoUrl || window.DEFAULT_LOGO, (function(root) {
  ...
  appStamp: "github-pages-static-commission-v1.2-deep-stability-hardening-2026-07-10-r18",
  ...
  stamp: "asset-manifest-commission-v1.2-deep-stability-hardening-2026-07-10-r18",
  bundles: {
    appCritical: {
      files: []
    },
