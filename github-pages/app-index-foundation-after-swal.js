(function(root) {
...
}, window.appManifestIconType = window.appManifestIconType || function(src) {
  ...
  icons: [{
      ...
      sizes: "192x192",
      type: window.appManifestIconType(window.APP_LOGO.png192)
    },
    {
      src: window.APP_LOGO.png512,
      sizes: "512x512",
      type: window.appManifestIconType(window.APP_LOGO.png512)
    }]
};
try {
...
window.__SAFE_LOGO_URL__ = window.currentLogoUrl || window.DEFAULT_LOGO, (function(root) {
  ...
  appStamp: "github-pages-static-commission-v1.2-gas-hosted-production-2026-07-10-r30",
  ...
  stamp: "asset-manifest-commission-v1.2-gas-hosted-production-2026-07-10-r30",
  bundles: {
    appCritical: {
      files: []
    },
