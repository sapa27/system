...
window.__SAFE_LOGO_URL__ = window.currentLogoUrl || window.DEFAULT_LOGO, (function(root) {
  ...
  appStamp: "github-pages-static-commission-v1.2-gas-hosted-production-2026-07-10-r29",
  ...
  stamp: "asset-manifest-commission-v1.2-gas-hosted-production-2026-07-10-r29",
  bundles: {
    appCritical: {
      files: []
    },
