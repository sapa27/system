(function(root) {
    ...
    ,
    APP_RELEASE_STAMP = "commission-v1.2-deep-stability-hardening-2026-07-10-r18",
    APP_ASSET_STAMP = "asset-manifest-commission-v1.2-deep-stability-hardening-2026-07-10-r18",
    ...
    defaults = {
      ...
      gasBackendFrontendRedirectProperty: "VERCEL_FRONTEND_URL",
    ...
    root.APP_CONFIG.clientApiCacheEnabled = !1,
    root.APP_CONFIG.clientReadResponseCacheEnabled = !1,
    root.APP_CONFIG.clientSessionStorageReadCacheEnabled = !1,
    ...
    root.APP_CONFIG.fastLoginJsonp = !1,
    root.APP_CONFIG.fastLoginJsonpDisabled = !0,
    root.APP_CONFIG.requireBridgeReadyMessage = !0,
    root.APP_CONFIG.allowAssumedBridgeReady = !1,
    ...
    root.APP_CONFIG.runtimeSlimmingEnabled = !0,
    root.APP_CONFIG.vercelStaticFrontendReady = !0,
    root.APP_CONFIG.vercelApiProxyEnabled = !0,
    root.APP_CONFIG.loginViaVercelProxy = !0,
    root.APP_CONFIG.loginFormPost = !1,
    ...
    root.APP_CONFIG.staticApiContractAllowlistDisabled = !0,
    root.APP_CONFIG.legacyTransportRemoved = !0,
    root.APP_CONFIG.legacyJsonpTransportRemoved = !0,
    root.APP_CONFIG.legacyGasBridgeTransportRemoved = !0,
    root.APP_CONFIG.legacyLoginPostIframeRemoved = !0,
    root.APP_CONFIG.frontendTransportSinglePathPhase2 = !0,
    root.APP_CONFIG.staticGasDirectDisabled = !0,
    root.APP_CONFIG.gasDirectFallbackDisabled = !0,
    root.APP_CONFIG.readJsonpApi = !1,
    ...
    root.APP_CONFIG.releaseManifest = Object.assign({
      }
      , root.APP_CONFIG.releaseManifest || {
      }
      , {
        stamp: APP_RELEASE_STAMP,
        cacheBustVersion: APP_RELEASE_STAMP
    ...
    root.APP_CONFIG.assetManifest = Object.assign({
      }
      , root.APP_CONFIG.assetManifest || {
      }
      , {
        stamp: APP_ASSET_STAMP
      }
    ...
    try {
      ...
      logoUrl = params.get("logo") || params.get("logoUrl") || "",
      transport = params.get("transport") || ""; 
      if (logoUrl && isSafeLogoUrl(logoUrl) &&(root.localStorage && root.localStorage.setItem("APP_LOGO_URL",
            logoUrl.trim()), root.APP_CONFIG.logoUrl = logoUrl.trim()), !root.APP_CONFIG.gasWebAppUrl && VERCEL_GAS_WEB_APP_URL &&(root.APP_CONFIG.gasWebAppUrl = VERCEL_GAS_WEB_APP_URL),
        (!root.APP_CONFIG.logoUrl || root.APP_CONFIG.logoUrl === FALLBACK_LOGO) && VERCEL_LOGO_URL && isSafeLogoUrl(VERCEL_LOGO_URL) &&(root.APP_CONFIG.logoUrl = VERCEL_LOGO_URL),
        root.localStorage) {
        var storedLogo = cleanUrl(root.localStorage.getItem("APP_LOGO_URL") || ""),
        badLogo = cleanUrl(root.localStorage.getItem("APP_BAD_LOGO_URL") || ""); 
        storedLogo && storedLogo === badLogo &&(storedLogo = ""),
        storedLogo && isSafeLogoUrl(storedLogo) &&(root.APP_CONFIG.logoUrl = storedLogo),
        storedLogo && !isSafeLogoUrl(storedLogo) && root.localStorage.removeItem("APP_LOGO_URL")
      }
      isSafeLogoUrl(root.APP_CONFIG.logoUrl) ||(root.APP_CONFIG.logoUrl = FALLBACK_LOGO),
      root.APP_CONFIG.logoUrl ||(root.APP_CONFIG.logoUrl = FALLBACK_LOGO),
      transport && /production-vercel-proxy-only/i.test(transport) ? root.APP_CONFIG.transportMode = transport: root.APP_CONFIG.transportMode = "production-vercel-proxy-only-no-jsonp-no-bridge-no-login-iframe"
    } 
    catch (_) {
    }
