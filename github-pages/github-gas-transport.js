(function (root, doc) {
  ...
  var RELEASE_STAMP = String((root.APP_CONFIG || {}).releaseStamp || "commission-v1.2-gas-hosted-production-2026-07-23-r153");
  var ASSET_STAMP = String((root.APP_CONFIG || {}).assetStamp || "asset-manifest-commission-v1.2-gas-hosted-production-2026-07-23-r153");
